        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="bg-slate-800 p-2 rounded hover:bg-red-600 transition-colors text-white">
                <Facebook size={20} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/services" className="hover:text-red-500 transition-colors">Event Medical Cover</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="font-semibold text-white">+880 175 794 9128</span>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="text-red-500 shrink-0 mt-1" size={18} />
                <span>C&F Tower, Ma O Shishu Hospital, Zambuti Field, Chattogram 4100</span>
              </li>
              <li className="flex items-start gap-3">
